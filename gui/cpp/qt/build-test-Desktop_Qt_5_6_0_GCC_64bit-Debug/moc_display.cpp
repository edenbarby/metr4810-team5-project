...
QT_MOC_LITERAL(1, 8, 20), // "maxPressCountReached"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 17), // "slotButtonClicked"
QT_MOC_LITERAL(4, 48, 7) // "checked"

    },
    "Display\0maxPressCountReached\0\0"
    "slotButtonClicked\0checked"
};
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->maxPressCountReached(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Display::maxPressCountReached)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Display::maxPressCountReached()
{
